...
const workJSON = [
  {
    ...
    desc: (
      <>
        <p>
          I held a variety of roles during my time at Indeed, and I'm grateful
          for the ways I was able to grow and contribute to the company.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            entirely new front-end framework for Indeed’s employer products –
            the largest technical effort in Indeed’s history.
          </li>
          <li>
  ...
  },
  {
    ...
    desc: (
      <p>
        At ShipStation, I led the design team’s work, mentoring junior designers
        and setting up processes for our work and collaboration with other
        departments. I worked closely with engineers to develop a design system
        and front-end component library, establishing best practices for
  ...
  },
  {
    ...
    desc: (
      <p>
        ...
        marketing side, I designed and implemented the company's website, helped
        lead marketing campaign efforts, and directed the creation of numerous
        print and digital artifacts to support those efforts.
      </p>
    ),
  },
  {
  ...
  return (
    <div className="cv-container">
      <div className="callout">
        <p>
          I've worked with a variety of companies and teams over the years, and
          I'm grateful for the experience they've given me. Here's a quick
